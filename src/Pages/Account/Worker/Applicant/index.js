...
const Applicant = () => {
    ...
    useEffect(() => {
        ...
        setAvailable({
            min: dataProfile.available_from || '',
            max: dataProfile.available_to || '',
        })
    }, [dataProfile]);
                        ...
                        <div className={styles.tab}>
                            ...
                            <div className={styles.header}>
                                <div
                                    ...
                                    onClick={() => {setTab(0)}}
                                >
                                    {translate('section_description_work')}
                                </div>
                                <div
                                    className={classes(styles.link, tab === 1 && styles.active)}
                                    onClick={() => {setTab(1)}}
                                >
                                    {translate('section_description_language')}
                                </div>
                                <div
                                    className={classes(styles.link, tab === 2 && styles.active)}
                                    onClick={() => {setTab(2)}}
                                >
                                    {translate('section_description_skills')}
                                </div>
                            </div>
